  ...
  return (
    <section className="relative w-full bg-[#0D1512] dark-texture text-[#F7F3E8] pt-44 pb-6 sm:pt-48 sm:pb-8 md:pt-52 md:pb-8 lg:pt-20 lg:pb-10 px-6 overflow-hidden">
      ...
      <div className="max-w-[640px] mx-auto text-center relative z-10">
        ...
        <h2 className="reveal-init serif-title text-3xl sm:text-4xl md:text-5xl text-[#F7F3E8] font-medium tracking-[0.14em] mb-6 drop-shadow-sm">
        ...
        <p
          ...
          className="reveal-init font-body text-base sm:text-lg text-[#EDE6D3]/90 leading-relaxed mb-6 max-w-[540px] mx-auto"
        >
        ...
        <p
          ...
          className="reveal-init font-body text-base sm:text-lg text-[#EDE6D3] italic leading-relaxed font-light mt-6 mb-8"
        >
        ...
        <div data-reveal-delay="240" className="reveal-scale-init flex items-center justify-center space-x-3 mt-12 text-[#EDE6D3]/35">
