  ...
  return (
    <section className="w-full bg-night dark-texture text-ivory pt-16 sm:pt-24 pb-0 text-center">
      ...
      <div className="max-w-[680px] mx-auto px-6 mb-12 sm:mb-16">
        ...
        {/* Section Heading */}
        <h2 className="serif-title text-3xl sm:text-4xl md:text-5xl text-[#F7F3E8] font-normal tracking-[0.15em] mb-6">
          {content.location_heading}
        </h2>

        {/* Lead sentence with merge fields */}
        <p className="font-body text-lg sm:text-xl text-[#F7F3E8]/85 leading-relaxed font-light mb-4">
        ...
        <div className="mt-8">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xs text-[11px] sm:text-xs serif-title tracking-widest bg-[#1B4332] text-[#F7F3E8] hover:bg-[#255a43] border border-emerald-light/40 transition-all duration-300 shadow-md hover:shadow-lg"
          >
